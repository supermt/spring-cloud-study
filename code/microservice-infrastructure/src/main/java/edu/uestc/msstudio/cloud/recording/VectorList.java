...
public class VectorList {
	...
	static {
		...
		vectors.put(LifeCycleActions.createUser, new VectorDesc(LifeCycleStatus.InAction,LifeCycleStatus.Saved,User.class,User.class));
		...
		typeMap.put(List.class, ObjectType.List);
